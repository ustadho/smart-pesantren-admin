...
@Component({
  selector: 'app-student-category-edit',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, BaseInputComponent, SubmitButtonComponent],
  templateUrl: './student-category-edit.component.html',
  styleUrl: './student-category-edit.component.scss'
})
