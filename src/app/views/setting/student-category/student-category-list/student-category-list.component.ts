...
@Component({
  selector: 'app-student-category-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './student-category-list.component.html',
  styleUrl: './student-category-list.component.scss'
})
export class StudentCategoryListComponent {
  ...
  private service = inject(StudentCategoryService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/setting/student-category'], {
