...
@Component({
  ...
  templateUrl: './pesantren-list.component.html',
  styleUrl: './pesantren-list.component.scss'
})
export class PesantrenListComponent {
  ...
  private service = inject(PesantrenService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/setting/pesantren'], {
