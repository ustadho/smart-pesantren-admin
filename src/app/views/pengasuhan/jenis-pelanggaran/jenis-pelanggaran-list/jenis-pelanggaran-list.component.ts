...
@Component({
  selector: 'app-jenis-pelanggaran-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './jenis-pelanggaran-list.component.html',
  styleUrl: './jenis-pelanggaran-list.component.scss'
})
export class JenisPelanggaranListComponent {
  ...
  private service = inject(JenisPelanggaranService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/pengasuhan/jenis-pelanggaran'], {
