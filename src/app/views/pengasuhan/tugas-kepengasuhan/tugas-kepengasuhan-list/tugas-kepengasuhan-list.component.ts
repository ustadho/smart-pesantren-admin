...
import { TugasKepengasuhanService } from '../../../../domain/service/tugas-kepengasuhan.service';
import { ActivatedRoute, Router } from '@angular/router';
import { HttpHeaders } from '@angular/common/http';

@Component({
  selector: 'app-tugas-kepengasuhan-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './tugas-kepengasuhan-list.component.html',
  styleUrl: './tugas-kepengasuhan-list.component.scss'
})
export class TugasKepengasuhanListComponent {
  ...
  private service = inject(TugasKepengasuhanService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/pengasuhan/tugas-kepengasuhan'], {
