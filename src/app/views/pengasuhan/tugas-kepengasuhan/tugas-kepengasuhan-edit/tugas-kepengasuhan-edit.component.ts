...
@Component({
  selector: 'app-tugas-kepengasuhan-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './tugas-kepengasuhan-edit.component.html',
  styleUrl: './tugas-kepengasuhan-edit.component.scss'
})
export class TugasKepengasuhanEditComponent {
  ...
  constructor(
    ...
    private service: TugasKepengasuhanService,
