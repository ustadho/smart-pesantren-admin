...
@Component({
  selector: 'app-jenis-prestasi-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './jenis-prestasi-edit.component.html',
  styleUrl: './jenis-prestasi-edit.component.scss'
})
export class JenisPrestasiEditComponent {
  ...
  constructor(
    ...
    private service: JenisPrestasiService,
