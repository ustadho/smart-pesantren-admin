...
import { JenisPrestasiService } from '../../../../domain/service/jenis-prestasi.service';
import { ActivatedRoute, Router } from '@angular/router';
import { HttpHeaders } from '@angular/common/http';

@Component({
  selector: 'app-jenis-prestasi-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './jenis-prestasi-list.component.html',
  styleUrl: './jenis-prestasi-list.component.scss'
})
export class JenisPrestasiListComponent {
  ...
  private service = inject(JenisPrestasiService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/pengasuhan/jenis-prestasi'], {
