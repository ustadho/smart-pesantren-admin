...
@Component({
  ...
  templateUrl: './jenis-izin-edit.component.html',
  styleUrl: './jenis-izin-edit.component.scss'
})
export class JenisIzinEditComponent {
  ...
  constructor(
    ...
    private service: JenisIzinService,
