...
import { JenisIzinService } from '../../../../domain/service/jenis-izin.service';
import { ActivatedRoute, Router } from '@angular/router';
import { HttpHeaders } from '@angular/common/http';

@Component({
  selector: 'app-jenis-izin-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './jenis-izin-list.component.html',
  styleUrl: './jenis-izin-list.component.scss'
})
export class JenisIzinListComponent {
  ...
  private service = inject(JenisIzinService);
  ...
  transition(sortState?: SortState): void {
    this.router.navigate(['/pengasuhan/jenis-izin-santri'], {
