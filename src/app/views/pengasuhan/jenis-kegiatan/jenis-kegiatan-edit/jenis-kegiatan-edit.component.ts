...
@Component({
  selector: 'app-jenis-kegiatan-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './jenis-kegiatan-edit.component.html',
  styleUrl: './jenis-kegiatan-edit.component.scss'
})
export class JenisKegiatanEditComponent {
  ...
  constructor(
    ...
    this.form = fb.group({
      ...
      description: [null],
      inTime: ['07:00', [Validators.required]],
