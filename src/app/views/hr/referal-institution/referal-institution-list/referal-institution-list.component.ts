...
@Component({
  selector: 'app-referal-institution-list',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './referal-institution-list.component.html',
})
export class ReferalInstitutionListComponent implements OnInit {
    ...
    private service = inject(ReferalInstitutionService);
    ...
    transition(sortState?: SortState): void {
      this.router.navigate(['/hr/referal-institution'], {
